...
COMMANDS: list[BotCommand] = [
    ...
    BotCommand("remind", "Create a reminder (one-time, weekly, monthly, or note)"),
...
COMMANDS_UK: list[BotCommand] = [
    ...
    BotCommand("remind", "Створити нагадування (разове, щотижневе, щомісячне або нотатка)"),
...
SHORT_DESCRIPTION = (
    "One-time, weekly and monthly reminders, plus quick notes that nudge you every 2 hours."
)
...
DESCRIPTION = (
    "I help you not to forget things. One-time, weekly and monthly reminders, plus "
    "quick notes that nudge you every 2 hours until you close them. Tap START to begin."
)
